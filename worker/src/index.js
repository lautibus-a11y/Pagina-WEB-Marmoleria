...
Variedades y modelos disponibles:
- Blancos Clásicos y Traslúcidos: Carrara, Calacatta Extra, Calacatta Oro, Calacatta Monet, Calacatta Viola, Estatuario Clásico, Blanco Thassos (el más blanco puro), Arabescato Clásico, Arabescato Di Luca, Blanco Perlino, Blanco Royal, Blanco Cristal, Luxury White, Mosa White, Fantasy White, Invisible Grey, Cote d Azur.
- Negros y Oscuros de Alto Lujo: Negro Marquina, Portoro Super (fondo negro con vetas doradas), Sahara Noir, Noir Saint Laurent, Grigio Carnico, Antracite Dark, Tundra Black, Tundra Grey, Savana Grey, Fantastic Grey, Silver Wave, Silver Galaxy.
- Colores Exóticos y Vetas Nobles: Verde Alpe, Verde Bosque, Verde Oriental, Verde Arcadia, Verde Remigiato, Fendi Green, Rosso Levanto (bordó/ciruela), Rosso Venato, Rojo Alicante, Rosa Norvegia, Rosalía, Giallo di Siena (amarillo dorado), Lilac / Milas Lilac (vetas violetas/grafito), Flor di Pesco Carnico, Arabescato Orobico, Camouflage Mármol.
- Tonos Beige, Arena y Marrones: Crema Marfil, Botticino, Beige Sahara, Beige Nilo, Moon Beige, Moon Beige Classic, Marrón Imperial, Marrón Bosque, Desert Brown, Jura Beige (con fósiles marinos), Jura Grey.
- Travertinos Naturales y Breccias: Travertino Romano Striatto, Travertino Ivory a la Veta, Travertino Clásico a la Veta, Travertino al Agua, Travertino Noce al Agua, Travertino Titanium, Breccia Toscano, Breccia Vaticano.
